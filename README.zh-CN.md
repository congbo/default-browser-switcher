...
<p align="center">
  <img src="docs/images/menu-bar-runtime.png" alt="菜单栏运行时截图" width="360" />
</p>
...
由于 macOS 的安全机制，非 App Store 下载的应用有时会触发这类提示。你可以按下面的方法处理：
...
1. `命令行修复`（推荐）
   ...
   > 注意：如果你修改过应用名称，请把命令里的路径改成对应的实际应用路径。

2. 或者在“系统设置” -> “隐私与安全性”中点击“仍要打开”。
