...
8. Confirm `Launch at login` is available from the installed release build.
9. Confirm `Refresh` keeps the browser list usable, and if you can reproduce a failed or stale switch state, confirm `Retry` helps recover.
